...
import { useAdminEquipmentCreateScreen } from './hooks/useAdminEquipmentCreateScreen';

const AdminEquipmentCreateScreen = () => {
    const hookMember = useAdminEquipmentCreateScreen();
...
export default AdminEquipmentCreateScreen;
